...
namespace SIGEBI.Desktop.Presentacion.Views.Recursos
{
    public partial class AgregarRevistaDialog : Window
    {
        ...
        private async void BtnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            var edicion = int.TryParse(TxtEdicion.Text, out var ed) ? ed : 1;
            var req = new CrearRevistaRequest(idCat, TxtCodigo.Text, TxtTitulo.Text, TxtAutor.Text, stock, null, edicion, null);
